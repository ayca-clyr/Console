    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (seçenek)
            {
                ...
                if (durum == false)
                {
                    Console.WriteLine("Yanlış giriş yaptınız: Lütfen menüden belirtilen sayısal ifadelerden birini girinzz");
                }
                else
                {
                    ...
                    if (secim == 1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.Write("Yanlış tahmin yaptınız. Lütfen yeniden tahminde bulunun:");
                    ...
                    else if (secim == 3)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.WriteLine("Yanlış tahmin yaptınız. Lütfen yeniden tahminde bulunun:");
                                counter++;
                            }
